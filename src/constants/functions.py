...
def koza_1(input: np.ndarray[np.ndarray[float]]) -> np.ndarray[float]:
	x = input[0]
	return x ** 4 + x ** 3 + x ** 2 + x

koza_1_input = training_set_1
koza_1_wanted_output = koza_1(koza_1_input)
...
def nguyen_1(input: np.ndarray[np.ndarray[float]]) -> np.ndarray[float]:
	x = input[0]
	return x ** 3 + x ** 2 + x

nguyen_1_input = training_set_1
nguyen_1_wanted_output = nguyen_1(nguyen_1_input)

def nguyen_3(input: np.ndarray[np.ndarray[float]]) -> np.ndarray[float]:
	x = input[0]
	return x ** 5 + x ** 4 + x ** 3 + x ** 2 + x

nguyen_3_input = training_set_1
nguyen_3_wanted_output = nguyen_3(nguyen_3_input)
...
functions = {
	# 'koza_1': { # not used, too hard to solve :(
	# 	'function': koza_1,
	# 	'input': koza_1_input,
	# 	'wanted_output': koza_1_wanted_output,
	# 	'n_inputs': 1,
	# 	'name': 'Koza 1',
	# 	'n_columns': 150,
	# 	"mutation_rate": 0.05,
	...
	# 'nguyen_1': {
	# 	'function': nguyen_1,
	# 	'input': nguyen_1_input,
	# 	'wanted_output': nguyen_1_wanted_output,
	# 	'n_inputs': 1,
	# 	'name': 'Nguyen 1'
	# },
	# 'nguyen_3': {
	# 	'function': nguyen_3,
	# 	'input': nguyen_3_input,
	# 	'wanted_output': nguyen_3_wanted_output,
	# 	'n_inputs': 1,
	# 	'name': 'Nguyen 3'
	# },
	'nguyen_4': {
