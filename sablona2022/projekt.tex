...
\projectinfo{
  ...
  title.cs={Využití operátoru křížení v kartézském genetickém programování},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  ...
  author.surname={Bromnik},   % příjmení autora / author surname 
  ...
  supervisor.surname={Hurta},   % příjmení školitele / supervisor surname
